...
<div class="container-fluid header-img">
    <div class="row">
        <div class="col-md-6 offset-md-3">
            <div class="header">
                <h1 class="text-center;" style="font-weight:bold;font-size: 50px;text-align: center;">Donate the blood, save the life</h1>
                <p class="text-center" style="color: white;">Donate the blood to help the others.</p>
            </div>
            <h1 class="text-center">Search The Donors</h1>
            <hr class="white-bar text-center">
            <form action="search.php" method="get" class="form-inline offset-md-1" style="padding: 40px 0px 0px 5px;">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <p class="text-center pera-text">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quos quidem voluptatum aperiam optio minus itaque, alias labore sunt, illum quaerat veritatis ratione. Modi tempora, officiis quo corporis necessitatibus facere vitae ut eaque fuga recusandae quia nulla quasi repellat ipsa, ad iste, rerum molestiae minima quod delectus dolore ratione, tenetur consectetur magni. Sed repellat quasi ipsam doloribus provident, quis harum magnam, veritatis eum perspiciatis, consectetur praesentium nihil velit laboriosam in. Molestiae magni voluptas mollitia reiciendis perferendis nemo aspernatur magnam neque obcaecati suscipit, distinctio, placeat voluptate soluta praesentium, itaque doloribus. Dignissimos ipsa ut perspiciatis sequi, eveniet itaque. Neque quisquam rem quasi ea?
            </p>
    ...
    <div class="row">
        <div class="col">
            <div class="card">
                ...
                <p class="text-center">
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fugiat cupiditate aliquam sed nesciunt accusantium fugit iusto cumque reiciendis numquam. Nemo, quae. Optio neque magni minima! Iste, quae! Excepturi consectetur, amet accusamus fugiat nostrum reiciendis adipisci alias quam. Eveniet provident harum accusantium eius eos tempore.
                </p>
            </div>
        </div>
        <div class="col">
