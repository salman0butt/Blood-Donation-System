...
<div class="container-fluid red-background size">
    <div class="row">
        <div class="ccol-md-6 offset-md-3">
            ...
            <hr class="white-bar">
            <br>
            <div class="form-inline text-center" style="padding: 40px 0px 0px 5px;margin-left: 80px;">
                <div class="form-group text-center center-aligned">
                    <select style="width: 220px; height: 45px;" name="city" id="city" class="form-control demo-default" required>
                        <?php if(isset($_GET['city'])) echo '<option selected value="'.$_GET["city"].'">'.$_GET["city"].'</option>'; ?>
                ...
                <div class="form-group center-aligned">
                    <select name="blood_group" id="blood_group" style="padding: 0 20px; width: 220px; height: 45px;" class="form-control demo-default text-center margin10px">
                        <?php if(isset($_GET['blood_group'])) echo '<option selected value="'.$_GET["blood_group"].'">'.$_GET["blood_group"].'</option>'; ?>
