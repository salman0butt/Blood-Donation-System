					...
					<div class="panel panel-default" style="padding: 20px;">
						<div class="panel-body">
							...
							<div class="heading text-center">
								<h3 style="font-size: 43px;font-weight: bold;">Welcome!</h3><h1 style="font-weight: bold;"><?php if (isset($_SESSION['name'])) {
		echo $_SESSION['name'];
	}
	?></h1>
							</div><br>
							<p class="text-center" style="font-size: 22px;">Here you can mennage your account update your profile</p><br>
...
$safeDate = $_SESSION['save_life_date'];
	...
	if ($safeDate == '0') {
		...
		if ($diffMonth >= 3) {
			...
			echo '<div class="donors_data text-center">
							<span class="name">Congratuelations!</span>
							<span>You Already save the life.You will donate the blood after three months.we are very thanking full to you.</span>
							</div>';
