	...
	if (isset($_POST['update'])) {
		...
		if (isset($_POST['name']) && !empty($_POST['name'])) {
			if (preg_match('/^[A-Za-z\s]+$/', $_POST['name'])) {
             ...
             <strong>Only Lowercase and Uppercase and Spaces are allowed.</strong>
		...
		if (isset($_POST['contact_no']) && !empty($_POST['contact_no'])) {
			if (preg_match('/^\d{11}/', $_POST['contact_no'])) {
             ...
             <strong>Contact no consist of 11 characters.</strong>
             <button type="button" class="close" data-dismiss="alert" aria-label="Close">
          <span aria-hidden="true">&times;</span>
         </button>
         </div>';
			...
			$contactError = '<div class="alert alert-danger alert-dismissible fade show" role="alert">
             <strong>Please Fill the Contact no.</strong>
             <button type="button" class="close" data-dismiss="alert" aria-label="Close">
          <span aria-hidden="true">&times;</span>
         </button>
         </div>';
		...
		if (isset($_POST['email']) && !empty($_POST['email'])) {
			...
			if (preg_match($pattern, $_POST['email'])) {
             ...
             <strong>Email formate is not correct.</strong>
             <button type="button" class="close" data-dismiss="alert" aria-label="Close">
          <span aria-hidden="true">&times;</span>
         </button>
         </div>';
		...
		if (isset($name) && isset($blood_group) && isset($gender) && isset($day) && isset($month) && isset($year) && isset($email) && isset($contact_no) && isset($city)) {
			...
			if ($result) {
				...
				$updated = '<div class="alert alert-success alert-dismissible fade show" role="alert">
...
<?php
	...
	if (isset($_POST['update_pass'])) {
		if (isset($_POST['old_password']) && !empty($_POST['old_password']) && isset($_POST['c_password']) && !empty($_POST['c_password']) && isset($_POST['new_password']) && !empty($_POST['new_password'])) {
          ...
          <span aria-hidden="true">&times;</span>
					...
					$passwordError = '<div class="alert alert-danger alert-dismissible fade show" role="alert">
             <strong>Password should be atleast 6 characters.</strong>
             <button type="button" class="close" data-dismiss="alert" aria-label="Close">
          <span aria-hidden="true">&times;</span>
         </button>
         </div>';
		...
		if (isset($password)) {
			...
			if ($status) {
				$updated_password = '<div class="alert alert-success alert-dismissible fade show" role="alert">
	...
	if (isset($_POST['delete_account'])) {
		...
		if (isset($_POST['account_password']) && !empty($_POST['account_password'])) {
            ...
            if($account_password == $db_password){

                     $showForm = '

        <div class="alert alert-danger alert-dismissible fade show" role="alert">
                <strong>Are you Sure to Delete your Accoount?</strong>
                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
...
<div class="container" style="padding: 60px 0;">
    ...
    <?php if (isset($updated)) {echo $updated;}?>
                ...
                <form class="form-group" action="" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="fullname" placeholder="Full Name" required pattern="[A-Za-z/\s]+" title="Only lower and upper case and space" class="form-control" value=" <?php if (isset($name)) {
		echo ltrim($name);
	}
	?>">
	...
	?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="contact_no" placeholder="03********" class="form-control" required pattern="^\d{11}$" title="11 numeric characters only" maxlength="11 " value="<?php if (isset($contact_no)) {
		echo $contact_no;
	}
	?>">
	...
	?>
                    ...
                    <!--End form-group-->
                    <div class="form-group">
                        <button id="update" name="update" type="submit" class="btn btn-lg btn-danger center-aligned" style="margin-top: 20px;">Update</button>
                    </div>
                </form>
            </div>
        </div>
        <div class="card col-md-6 offset-md-3">
            <div class="panel panel-default" style="padding: 20px;">
                ...
                <?php if (isset($updated_password)) {echo $updated_password;}?>
